    ...
    <FooterSectionContainer>
      <div className="footer-content">
        ...
        <ul>
          ...
          <li>
            <a href="https://github.com/koshikraj/asguard-app" target="_next">
              GitHub
            </a>
          </li>
          <li>
            <a href="https://docs.asguard.life" target="_next">
              Documentation
            </a>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <a href="https://twitter.com/asguardlife" target="_next">
              Twitter
            </a>
          </li>
          <li>
      ...
      <div className="footer-copy">
        <Paragraph centered>
          {" "}
          &copy; {new Date().getFullYear()} - Crafted with ❤️ by Asguard.{" "}
        </Paragraph>
      </div>
    </FooterSectionContainer>
  );
